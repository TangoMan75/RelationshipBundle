...
trait HasRelationships
{
     ...
     * Warning: This will probably disable `by_reference` access to any object
     * property.
     *
     * @param $name
     *
    ...
    {
        $validMethods = implode(
            "|",
            array_merge(self::$genericMethods, self::$arrayMethods)
        );
        ...
        if ( ! property_exists($this, $property)
            ...
            throw new \BadMethodCallException(
                'Method: '.$method.', or property: '.$property
                .' doesn\'t exist in class: '.get_class(
                    $this
                )
            );
        }
        ...
        throw new \BadMethodCallException(
            'Method '.$method.' doesn\'t exist in class: '.get_class($this)
        );
    }
